  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "float-soft": { "0%, 100%": { transform: "translate3d(0,0,0)" }, "50%": { transform: "translate3d(0,-10px,0)" } },
        "slide-up": { from: { opacity: "0", transform: "translateY(18px)" }, to: { opacity: "1", transform: "translateY(0)" } },
        "pulse-ring": { "0%, 100%": { boxShadow: "0 0 0 0 hsl(var(--primary) / .25)" }, "50%": { boxShadow: "0 0 0 12px hsl(var(--primary) / 0)" } },
      },
      animation: {
